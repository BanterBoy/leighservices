...
2. **Files you may edit**: `index.html`, `team.html`. No other files.
...
6. **Nav consistency**: Both `index.html` and `team.html` must have identical nav links. If nav changes, update both files.
